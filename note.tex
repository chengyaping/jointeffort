...
% Besides, a new Concept Scintillator Detector named WBLS  \cite{lab3} also tries
% to take advantage of both Cerenkov light and scintallation light. It's really the trend.
...
\begin{center}
\includegraphics[width=9.0cm]{eps/wavelength.eps}
...
\begin{figure}[htbp]
\centering % \begin{center}/\end{center} takes some additional vertical space
\includegraphics[width=.85\textwidth]{plots/rec_performance22.pdf}
% "\includegraphics" is very powerful; the graphicx package is already loaded
